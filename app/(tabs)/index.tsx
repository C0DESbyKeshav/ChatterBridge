...
import { Alert, Animated, Easing, ScrollView, Text, TouchableOpacity, View, TextInput, Image, Dimensions, Modal } from 'react-native';
    ...
    <LinearGradient colors={['#1f2937', '#000000']} className="flex-1">
      <SafeAreaView className="flex-1">
        ...
        <View className="w-auto h-96 mb-6 ml-6 mr-6 bg-gray-800 rounded-xl border border-gray-800">
          <ScrollView contentContainerClassName="flex-grow px-4 py-4">
            {transcribedText ? (
        ...
        <View className="w-full bg-transparent p-4 mb-4 flex items-center justify-center">
          ...
          <TouchableOpacity
            className={`bg-purple-400 py-3 px-6 rounded-full self-center mt-2 ${!selectedLanguage || isTranslating ? 'bg-[#a0aec0]' : ''
              }`}
